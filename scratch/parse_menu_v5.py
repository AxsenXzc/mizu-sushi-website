...
for idx, el in enumerate(elements):
    ...
    if el["type"] == "NAME":
        # A NAME starts a new item if current_item already has a description, price, or number.
        # Otherwise, it appends to the name parts (multi-line name).
        start_new = False
        if current_item:
        ...
        # A NUMBER ALWAYS belongs to the current item!
        if current_item is None:
            current_item = {
                "name_parts": [],
                "desc_parts": [],
...
with open(r"c:\Users\anelk\Desktop\Sito Web Mizu Sushi\scratch\parsed_menu_v5.json", 'w', encoding='utf-8') as f:
