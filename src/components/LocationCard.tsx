...
export default function LocationCard({
  ...
  return (
    <Tilt>
      <div className="relative p-8 rounded-2xl bg-gradient-to-br from-surface-light to-surface border border-white/10 transition-all duration-500 group hover:border-primary/50 hover:shadow-[0_20px_40px_-15px_rgba(196,30,58,0.2)] overflow-hidden">
